        ...
        <div className="bg-dark text-white vh-100 d-flex flex-column justify-content-between">
            <div className="p-3">
                ...
                <ul className="nav flex-column">
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-white d-flex justify-content-between align-items-center" href="#" onClick={toggleCustomerOrderMenu}>
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt-cutoff" viewBox="0 0 16 16">
                        ...
                        <div className={`collapse ${CustomerOrderMenu ? 'show' : ''}`}>
                            <ul className="nav flex-column ms-3">
                                <li className="nav-item">
